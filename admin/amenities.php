    ...
    <div class="modal" id="amenityModal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title"><i class="fas fa-concierge-bell"></i> <span id="modalTitle">Add New Amenity</span></h2>
            ...
            <div class="modal-footer">
                ...
                <button class="btn-form btn-primary-form" id="saveBtn">Save</button>
            </div>
        </div>
    </div>
</div>

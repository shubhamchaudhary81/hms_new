...
if ($_SERVER["REQUEST_METHOD"] == 'POST') {
    ...
    if (!(strlen($password) > 0)) {
        ...
        $errors['password_error'] = "Password should be at least 8 digits";
    } else {
        $pattern = "/^[a-zA-Z0-9@\.#]+$/";
    ...
    <div class="register-container">
        <div class="register-card">
            <div class="register-header">
                <h1><i class="register-title"></i>Guest Registration</h1>
            ...
            <div class="register-body">
                ...
                <form action="" method="POST" enctype="multipart/form-data" autocomplete="off" id="registrationForm">
                    ...
                    <div class="form-section">
                        ...
                        <div class="row form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text"><i class="bi bi-person user-type-icon"  style="color: var( --accent-color);"></i></span>
                        ...
                        <div class="row form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text"><i class="bi bi-envelope" style="color: var( --accent-color);"></i></span>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="number" class="form-label">Phone Number <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="bi bi-phone" style="color: var( --accent-color);"></i></span>
                                    <input type="tel" class="form-control" id="number" name="number"
                                        pattern="[0-9]{10,15}" placeholder="98XXXXXXXX" required>
                                </div>
                        ...
                        <div class="row form-row">
                            <div class="col-md-4 mb-3">
                                <label for="dob" class="form-label"> <i class="bi bi-calendar-date" style="color: var( --accent-color);"></i>
                                Date of Birth <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    ...
                                    <div class="gender-option">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="gender" id="genderMale"
                                                value="Male" required>
                                            <label class="form-check-label" for="genderMale"><i
                                                    class="fas fa-male me-1" style="color: var( --accent-color);"></i>
                                                Male</label>
                                        </div>
                                    </div>
                                    <div class="gender-option">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="genderFemale"><i
                                                    class="fas fa-female me-1" style="color: var( --accent-color);"></i> Female</label>
                                        </div>
                                    </div>
                                    <div class="gender-option">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="genderOther"><i
                                                    class="bi bi-gender-ambiguous me-1" style="color: var( --accent-color);"></i>
                                                Other</label>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="row form-row">
                            <div class="col-md-6 mb-3">
                                <label for="password" class="form-label">Password <span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="bi bi-lock"style="color: var( --accent-color);"></i></span>
                                ...
                                <div class="password-strength mt-2">
                                    ...
                                    <small id="password-strength-text" class="text-muted">Password strength: Very
                                        Weak</small>
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="password" class="form-control" id="confirm_password"
                                        name="confirm_password" minlength="8" placeholder="Confirm password"
                                        required>
                                    <span class="input-group-text toggle-password" style="cursor: pointer;">
                                        <i class="bi bi-eye" style="color: var( --accent-color);"></i>
                                    </span>
                        ...
                        <div class="row form-row">
                            <div class="col-md-6 mb-3">
                                <label for="profile_pic" class="form-label">Profile Picture <span
                                        class="text-danger">*</span></label>
                                <div class="profile-pic-container">
                                    <img id="profilePicPreview" class="profile-pic-preview" src="#"
                                        alt="Profile Preview">
                                    <div class="profile-upload-btn">
                                        <button type="button" class="btn btn-outline-secondary w-100" id="uploadBtn">
                                            <i class="bi bi-upload me-2"style="color: var( --accent-color);"></i>Upload Photo
                                        </button>
                        ...
                        <button type="submit" class="btn btn-login mb-3">
                            <i class="bi bi-person user-type-icon"style="color: var( --accent-color);"></i> Complete Registration
                        </button>
